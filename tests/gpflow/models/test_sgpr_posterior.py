...
def make_models(regression_data):
    ...
    mold = SGPR_deprecated(data=regression_data, kernel=k,inducing_variable=InducingPoints(Z))
    mnew = SGPR_with_posterior(data=regression_data, kernel=k,inducing_variable=InducingPoints(Z))
