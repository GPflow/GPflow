...
def test_predict_f_vs_predict_f_loaded_cache(
    ...
    model_1 = GPMC_deprecated(data=(X, Y), kernel=gpflow.kernels.Exponential(), likelihood=likelihood)
    model_2 = GPMC_with_posterior(data=(X, Y), kernel=gpflow.kernels.Exponential(), likelihood=likelihood)
