...
for i in range(iterations):
    adam_opt_for_gpr.minimize(gpr.training_loss,
...
for _ in range(ci_niter(100)):
    ordinary_adam_opt.minimize(svgp_ordinary_loss_closure, var_list=svgp_ordinary.trainable_variables)
