...
class TransformTests(ParallelTestCase):
    def setUp(self):
...
class TestOverflow(ParallelTestCase):
    """
...
class TestLowerTriTransform(ParallelTestCase):
    """
...
class TestDiagMatrixTransform(ParallelTestCase):
    def setUp(self):
        self.session = tf.Session()
