...
class NamingTests(ParallelTestCase):
...
class ParamTestsScalar(ParallelTestCase):
    def setUp(self):
...
class ParamTestsDeeper(ParallelTestCase):
    def setUp(self):
        tf.reset_default_graph()
        self.m = GPflow.param.Parameterized()
...
class ParamTestsWider(ParallelTestCase):
    def setUp(self):
        tf.reset_default_graph()
        self.m = GPflow.param.Parameterized()
...
class SingleParamterizedInvariantTest(ParallelTestCase):
    """
...
class SingleParamInvariantTest(ParallelTestCase):
    """
...
class TestParamList(ParallelTestCase):
...
class TestPickleAndDict(ParallelTestCase):
    def setUp(self):
...
class TestDictEmpty(ParallelTestCase):
    def setUp(self):
...
class TestDictSimple(ParallelTestCase):
    def setUp(self):
        self.m = GPflow.model.Model()
...
class TestDictSVGP(ParallelTestCase):
    def setUp(self):
...
class TestFixWithPrior(ParallelTestCase):
    """
...
class TestRandomizeDefault(ParallelTestCase):
    """
...
class TestRandomizePrior(ParallelTestCase):
    """
...
class TestRandomizeFeedPriors(ParallelTestCase):
    """
...
class TestRandomizeHierarchical(ParallelTestCase):
    """
...
class TestScopes(ParallelTestCase):
    def setUp(self):
        rng = np.random.RandomState(0)
        X = rng.randn(10, 1)
