...
#                                mean_function=GPflow.mean_functions.Constant())
    ...
    def test_all(self):
        ...
        self.assertTrue(np.allclose(pred_ydensity0, pred_ydensity_c0, atol = 1.0e-2))
        ...
        self.assertTrue(np.allclose(pred_ydensity1, pred_ydensity_c1, atol = 1.0e-2))
        ...
        pred_f_fullcov0   = self.vgp0.predict_f_full_cov(self.Xtest)
        pred_f_fullcov_c0 = self.cvgp.predict_f_full_cov(X_augumented0)
        pred_f_fullcov1   = self.vgp1.predict_f_full_cov(self.Xtest)
        pred_f_fullcov_c1 = self.cvgp.predict_f_full_cov(X_augumented1)
