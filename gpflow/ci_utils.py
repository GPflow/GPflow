...
def is_continuous_integration():
    """
    Returns `True` if notebooks are executed on CI system, otherwise `False`.
    Also returns `False` is `DOCS` environment variable is set,
    even when notebooks are executed on CI.
    """
