...
def _E__Gaussian__SquaredExponential__InducingPoints(
    p, kernel, inducing_variable, _, __, nghp=None
):
    """
    Compute the expectation:
    <K_{X, Z}>_p(X)
...
def _E__Gaussian__Identity__SquaredExponential__InducingPoints(
...
def _E__MarkovGaussian__Identity__SquaredExponential__InducingPoints(
    p, mean, _, kernel, inducing_variable, nghp=None
):
    """
    Compute the expectation:
...
def _E__Gaussian__SquaredExponential__InducingPoints__SquaredExponential__InducingPoints(
